...
// Progress bar with label and context for Available metrics (without redundant icon)
export function AvailabilityProgressBarV7({
  percentage,
  total,
  available,
  className,
...
// Timeline visualization for In Transit metrics (without redundant icon)
export function TransitTimelineV7({
  inTransit,
  total,
  className,
}: {
...
// Reservation gauge for Reserved metrics (without redundant icon)
export function ReservationGaugeV7({
  reserved,
  total,
  className,
}: {
...
// Display units visualization (without redundant icon)
export function DisplayUnitsVisualizationV7({
  display,
  total,
  className,
}: {
...
export function TotalVehiclesVisualizationV7({
  total,
  available,
  inTransit,
  reserved,
